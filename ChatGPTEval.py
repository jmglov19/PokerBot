...
def evaluate_action(hand, community_cards, round_num, min_bet, pot):
    ...
    if round_num == 0:
        ...
        if hand_score >= 7:
            return "raise"
        elif hand_score >= 5 and pot_odds <= 0.2:
            return "call"
        else:
            return "fold"
    elif round_num == 1:
        ...
        if hand_score >= 8:
            return "raise"
        elif hand_score >= 6 and pot_odds <= 0.2:
            return "call"
        else:
            return "fold"
    elif round_num == 2:
        ...
        if hand_score >= 9:
            return "raise"
        elif hand_score >= 7 and pot_odds <= 0.2:
            return "call"
        else:
            return "fold"
    else:
        ...
        if hand_score >= 10:
            return "raise"
        elif hand_score >= 8 and pot_odds <= 0.2:
            return "call"
        else:
            return "fold"
...
#player_hand = [(10, 'Clubs'), (11, 'Clubs')]
#community = [(12, 'C'), (13, 'C'), (14, 'Clubs')]


#print(evaluate_action(player_hand, community, 1, 5, 2))